...
Part A involved accessing the [2022 SAIPE State and Country Estimates for 2022](https://www.census.gov/data/datasets/2022/demo/saipe/2022-state-and-county.html), which organized all the U.S. counties by their poverty percentage.
...
The original SAIPE poverty data by county came from the [2022 SAIPE State and Country Estimates for 2022](https://www.census.gov/data/datasets/2022/demo/saipe/2022-state-and-county.html). I loaded this into Google Sheets.

I set up a Google Service account so that I could access this google sheet and my google drive from my python script image_retrieval.py. This script uses the Google Street View API to search for the county name and try to find an image for it. If an image is found, it is appropriately named, loaded into a Google Drive folder called 'CS 383/A3/images', and its name is listed in the “Image Found” column of the “Image Gathering” sheet in a Google spreadsheet. If an image is not found, that column is populated with “No”.
