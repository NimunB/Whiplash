...
for index, record in enumerate(records[:257]):
    if len(record) == 8 and index > 75: # Want to find a headline for this record
        ...
        response = requests.get(url, params={"q": headline_query, "apikey": api_keys["newsdata"], "language":"en"})
