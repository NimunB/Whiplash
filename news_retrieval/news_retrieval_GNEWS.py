...
# Define lists of good and bad words
...
for index, record in enumerate(records[:68]):
    if len(record) and index > 58: # Want to find a headline for this record
        ...
        response = requests.get(url, params={"q": headline_query, "apikey": api_keys["gnews"]})
